...
fn maximize_height(initial_theta : f32) -> f32{ 
    ...
    for _ in 0..num_iters { 
        ...
        println!("Current height of {} meters with angle of {}", out.data, theta.data.to_degrees());
...
fn maximize_range() { 
    ...
    for _ in 0..num_iters { 
        ...
        println!("Current range of {} meters with angle of {}", out.data, theta.data.to_degrees());
